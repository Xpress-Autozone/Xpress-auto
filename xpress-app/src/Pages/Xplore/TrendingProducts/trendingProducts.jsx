                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div className="space-y-2">
                            ...
                            <h1 className="text-4xl md:text-7xl font-black text-black uppercase italic tracking-tighter leading-none">
                                Hot Right <br/> <span className="text-gray-300">Now</span>
                            </h1>
                        </div>
                        <p className="text-gray-500 font-medium max-w-sm border-l-2 border-red-600 pl-4 text-sm leading-relaxed">
            ...
            <div className="max-w-7xl mx-auto px-6">
                {trendingProducts.length === 0 ? (
                    <div className="text-center py-32 border-2 border-dashed border-gray-100">
                        <p className="font-black uppercase tracking-widest text-gray-400">Zero Trending Items At This Moment</p>
                    </div>
                ) : (
