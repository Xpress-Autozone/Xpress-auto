...
import slideImage from "../../assets/interior.jpg";
import SkeletonLoader from "../../Components/SkeletonLoader/skeletonLoader";
import EmptyState from "../../Components/EmptyState/EmptyState";

export default function InteriorAccessoriesPage() {
    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:3001/api/search", {
          ...
          body: JSON.stringify({ query: "interior accessories", pageSize: 100 }),
        });
        ...
        <div className="relative h-34 md:h-30 lg:h-100 w-full overflow-hidden ">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center text-left px-6 md:px-12">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-100 max-w-2xl leading-relaxed">
              Enhance your vehicle's interior with our premium accessories
              collection featuring floor mats, seat covers, steering wheels, and
              comfort upgrades from trusted brands.
            </p>
          </div>
        </div>
      </div>
