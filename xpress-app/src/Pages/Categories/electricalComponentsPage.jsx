...
import slideImage from "../../assets/electrical.jpg";
    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:3001/api/search", {
          ...
          body: JSON.stringify({ query: "electrical components", pageSize: 100 }),
        });
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16">
      ...
      <div className="max-w-7xl mx-auto mb-12 ">
        <div className="relative h-34 md:h-30 lg:h-100 w-full overflow-hidden ">
          <img
            src={slideImage}
            alt="Electrical Components Hero"
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center text-left px-6 md:px-12">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-100 max-w-2xl leading-relaxed">
              Browse our selection of reliable electrical components including
              alternators, starters, batteries, and wiring harnesses from
