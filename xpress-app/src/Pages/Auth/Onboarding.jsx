...
import { Car, User, Phone, CheckCircle, ChevronRight, ArrowLeft, LogOut, Fuel, Globe, FastForward } from 'lucide-react';
...
const Onboarding = () => {
    ...
    return (
        <div className="min-h-screen bg-white pt-32 pb-20">
            <SEO title="Account Setup | Xpress Auto" description="Finish setting up your account for the best automotive experience." />
                ...
                <div className="mb-12 flex justify-between items-start">
                    <div>
                        ...
                        <p className="mt-4 text-gray-500 font-bold uppercase tracking-tight text-xs max-w-md">
                            Tailoring your online garage for the best experience and compatibility.
                        </p>
                    </div>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex items-center gap-3 mb-8 border-l-4 border-black pl-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Connect your mobile for instant access</p>
                                </div>
                            </div>

                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Secure Direct Line</label>
                            ...
                            >
                              Vehicle Profiling <ChevronRight className="group-hover:translate-x-2 transition-transform" />
                            </button>
                        </div>
                    )}
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex items-center gap-3 mb-8 border-l-4 border-black pl-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-black uppercase italic tracking-tight">Vehicle Profiling</h2>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Optimize compatibility filters</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Model Specification</label>
                                    <input
                                        type="text"
                                        name="carModel"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Year of Engineering</label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-400">Propulsion System</label>
                                    <div className="flex flex-wrap gap-2">
                                        {fuelTypes.map((type) => (
                                            <button
                                                ...
                                                className={`px-4 py-3 border-2 font-black uppercase text-[10px] tracking-widest transition-all ${formData.fuelType === type
                            ...
                            <div className="mt-8 p-6 bg-gray-50 border border-dashed border-gray-300 text-center">
                                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4">No vehicle to profile yet?</p>
                                <button
                                    type="button"
                                    onClick={skipVehicle}
                            ...
                            <div className="flex gap-4 pt-6">
                                ...
                                >
                                    Validate & Review <ChevronRight className="group-hover:translate-x-2 transition-transform" />
                                </button>
                            </div>
                        </div>
                    )}
                    ...
                    {step === 3 && (
                        <div className="space-y-6 text-center animate-in fade-in zoom-in duration-500">
                            ...
                            <h2 className="text-3xl md:text-4xl font-black uppercase italic tracking-tighter">Configuration Complete</h2>
                            <p className="text-gray-500 font-bold uppercase tracking-tight text-xs max-w-sm mx-auto">
                                Account settings saved. You can now access the full Xpress AutoZone catalog.
                            </p>

                            <div className="bg-gray-50 p-8 border-2 border-black text-left space-y-4 my-8 relative overflow-hidden">
                                <div className="absolute top-0 right-0 bg-black text-white px-3 py-1 text-[8px] font-black uppercase italic">Saved</div>
                                ...
                                <div className="flex justify-between border-b border-gray-200 pb-2">
                                    ...
                                    <span className="text-sm font-black uppercase tracking-tight">{formData.countryCode} {formData.phone}</span>
                                </div>
                                {isSkipped ? (
                                    <div className="flex justify-between">
                                        <span className="text-[10px] font-black text-gray-400 uppercase">Garage Status</span>
                                        <span className="text-sm font-black uppercase tracking-tight text-yellow-600">Standby / Pending</span>
                                    </div>
                                ) : (
                                    <>
                                        <div className="flex justify-between border-b border-gray-200 pb-2">
                                            <span className="text-[10px] font-black text-gray-400 uppercase">Machine</span>
                                            <span className="text-sm font-black uppercase tracking-tight">{formData.carYear} {formData.carMake} {formData.carModel}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-[10px] font-black text-gray-400 uppercase">Fuel Type</span>
                                            <span className="text-sm font-black uppercase tracking-tight">{formData.fuelType}</span>
                                        </div>
                                    </>
                                )}
                            </div>
